...
# Synthetic Quantum4DB Pipeline: (NL | CQM | BQM | ITER) over Synthetic instances
# Author: Hanwen Liu
# Date: 2026/01/09
#
# Layout:
...
from backend.utils import compute_db_cost
...
# SYNTHETIC_ROOT = str(BENCHMARK_ROOT / "Synthetic_Hanwen")

RESULTS_ROOT = Path(os.environ.get("QDBO_RESULTS_ROOT", PROJECT_ROOT))
OUT_DIR = str(RESULTS_ROOT / "results/synthetic_cpp_overhead")
LOG_DIR = str(RESULTS_ROOT / "results/synthetic_cpp_overhead/txt")
...
NL_TIME_LIMIT_S = 5
CQM_TIME_LIMIT_S = 5
NL_SAMPLER_LABEL = "Quantum4DB NL_Solver (Synthetic)"
CQM_LABEL = "Quantum4DB CQM (Synthetic)"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Synthetic Quantum4DB pipeline with optional iterative solver overrides."
    )
    parser.add_argument(
        "--iterations",
